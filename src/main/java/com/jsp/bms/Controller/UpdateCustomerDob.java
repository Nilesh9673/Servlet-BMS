...
@WebServlet("/updatecustomerdob")
public class UpdateCustomerDob extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (customerDto.getPassword().equals(password)) {
			customerServices.updateCustomersDobById(id, dob);
			printWriter.print("<html><body><h1>" + "Dob Updated Successfully" + "</h1></body></html>");
		} else {
