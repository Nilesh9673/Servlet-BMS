...
@WebServlet("/updatecustomeradharno")
public class UpdateCustomerAdhar extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (customerDto.getPassword().equals(password)) {
			customerServices.updateCustomersNameById(id, adharno);
			printWriter.print("<html><body><h1>" + "Adharno Updated Successfully" + "</h1></body></html>");
		} else {
