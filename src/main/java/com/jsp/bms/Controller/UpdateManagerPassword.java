...
@WebServlet("/updatemanagerpassword")
public class UpdateManagerPassword extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

		String new_password = req.getParameter("pass");
		...
		if (manager.getPassword().equals(password)) {
			managerService.updateManagerPasswordById(id, new_password);
			printWriter.print("<html><body><h1>" + "Password Updated Successfully" + "</h1></body></html>");
